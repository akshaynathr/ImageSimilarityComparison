...
static char __pyx_k_skimage_restoration__unwrap_1d[] = "skimage.restoration._unwrap_1d";
static char __pyx_k_strided_and_direct_or_indirect[] = "<strided and direct or indirect>";
static char __pyx_k_home_stefan_src_scikit_image_sk[] = "/home/stefan/src/scikit-image/skimage/restoration/_unwrap_1d.pyx";
 ...
 *     cdef:
 */
  __pyx_tuple__13 = PyTuple_Pack(5, __pyx_n_s_image, __pyx_n_s_unwrapped_image, __pyx_n_s_i, __pyx_n_s_difference, __pyx_n_s_periods); if (unlikely(!__pyx_tuple__13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__13);
  __Pyx_GIVEREF(__pyx_tuple__13);
  __pyx_codeobj__14 = (PyObject*)__Pyx_PyCode_New(2, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__13, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_stefan_src_scikit_image_sk, __pyx_n_s_unwrap_1d, 9, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "skimage.restoration._unwrap_1d")) {
      if (unlikely(PyDict_SetItemString(modules, "skimage.restoration._unwrap_1d", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef:
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7skimage_11restoration_10_unwrap_1d_1unwrap_1d, NULL, __pyx_n_s_skimage_restoration__unwrap_1d); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
