...
static char __pyx_k_home_stefan_src_scikit_image_sk[] = "/home/stefan/src/scikit-image/skimage/transform/_radon_transform.pyx";
 ...
 */
  ...
  /* "skimage/transform/_radon_transform.pyx":50
 *     cdef cnp.double_t index_i, index_j, weight
 ...
 */
    ...
    /* "skimage/transform/_radon_transform.pyx":53
 *         # step length between samples
 *         ds = 2 * s0 / Ns
 *         dx = -ds * cos(theta)             # <<<<<<<<<<<<<<
 *         dy = -ds * sin(theta)
 ...
 */
    ...
    /* "skimage/transform/_radon_transform.pyx":57
 *         # point of entry of the ray into the reconstruction circle
 *         x0 = s0 * cos(theta) - t * sin(theta)
 *         y0 = s0 * sin(theta) + t * cos(theta)             # <<<<<<<<<<<<<<
 *         for k in range(Ns+1):
 ...
 */
      ...
      /* "skimage/transform/_radon_transform.pyx":69
 *             # Use linear interpolation between values
 *             # Where values fall outside the array, assume zero
 *             if i > 0 and j > 0:             # <<<<<<<<<<<<<<
 *                 weight = (1. - di) * (1. - dj) * ds
 ...
 */
      ...
      if (__pyx_t_2) {
        ...
        /* "skimage/transform/_radon_transform.pyx":70
 *             # Where values fall outside the array, assume zero
 *             if i > 0 and j > 0:
 *                 weight = (1. - di) * (1. - dj) * ds             # <<<<<<<<<<<<<<
 *                 ray_sum += weight * image[i, j]
 ...
 */
  ...
  __pyx_t_14 = PyFloat_FromDouble(__pyx_v_ray_sum); if (unlikely(!__pyx_t_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_14);
  __pyx_t_15 = PyFloat_FromDouble(__pyx_v_weight_norm); if (unlikely(!__pyx_t_15)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_f_7skimage_9transform_16_radon_transform_bilinear_ray_update(__Pyx_memviewslice __pyx_v_image, __Pyx_memviewslice __pyx_v_image_update, __pyx_t_5numpy_double_t __pyx_v_theta, __pyx_t_5numpy_double_t __pyx_v_ray_position, __pyx_t_5numpy_double_t __pyx_v_projected_value, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "skimage/transform/_radon_transform.pyx":114
 *     """
 ...
 */
  __pyx_t_1 = __pyx_f_7skimage_9transform_16_radon_transform_bilinear_ray_sum(__pyx_v_image, __pyx_v_theta, __pyx_v_ray_position, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_6 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_6 == (npy_double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_7 = __pyx_PyFloat_AsDouble(__pyx_t_3); if (unlikely((__pyx_t_7 == (npy_double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_ray_sum = __pyx_t_6;
  __pyx_v_weight_norm = __pyx_t_7;

  /* "skimage/transform/_radon_transform.pyx":115
 *     cdef cnp.double_t ray_sum, weight_norm, deviation
 *     ray_sum, weight_norm = bilinear_ray_sum(image, theta, ray_position)
 *     if weight_norm > 0.:             # <<<<<<<<<<<<<<
 *         deviation = -(ray_sum - projected_value) / weight_norm
 ...
 */
  ...
  /* "skimage/transform/_radon_transform.pyx":119
 *     else:
 *         deviation = 0.
 *     theta = theta / 180. * M_PI             # <<<<<<<<<<<<<<
 *     cdef cnp.double_t radius = image.shape[0] // 2 - 1
 ...
 */
  ...
  /* "skimage/transform/_radon_transform.pyx":127
 *     # s0 is the half-length of the ray's path in the reconstruction circle
 *     cdef cnp.double_t s0
 ...
 */
  ...
  /* "skimage/transform/_radon_transform.pyx":128
 *     cdef cnp.double_t s0
 *     s0 = sqrt(radius*radius - t*t) if radius**2 >= t**2 else 0.
 *     cdef Py_ssize_t Ns = 2 * (<Py_ssize_t> ceil(2 * s0))             # <<<<<<<<<<<<<<
 *     cdef cnp.double_t hamming_beta = 0.46164    # beta for equiripple Hamming window
 ...
 */
  ...
  /* "skimage/transform/_radon_transform.pyx":134
 ...
 */
  ...
  if (__pyx_t_8) {
    ...
    /* "skimage/transform/_radon_transform.pyx":136
 *     if Ns > 0:
 *         # Step length between samples
 *         ds = 2 * s0 / Ns             # <<<<<<<<<<<<<<
 *         dx = -ds * cos(theta)
 ...
 */
    ...
    /* "skimage/transform/_radon_transform.pyx":137
 *         # Step length between samples
 *         ds = 2 * s0 / Ns
 *         dx = -ds * cos(theta)             # <<<<<<<<<<<<<<
 *         dy = -ds * sin(theta)
 ...
 */
    ...
    /* "skimage/transform/_radon_transform.pyx":140
 *         dy = -ds * sin(theta)
 *         # Point of entry of the ray into the reconstruction circle
 *         x0 = s0 * cos(theta) - t * sin(theta)             # <<<<<<<<<<<<<<
 *         y0 = s0 * sin(theta) + t * cos(theta)
 ...
 */
      ...
      /* "skimage/transform/_radon_transform.pyx":144
 *         for k in range(Ns+1):
 *             x = x0 + k * dx
 *             y = y0 + k * dy             # <<<<<<<<<<<<<<
 *             index_i = x + rotation_center
 ...
 */
      ...
      /* "skimage/transform/_radon_transform.pyx":156
 *                 image_update[i, j] += (deviation * (1. - di) * (1. - dj)
 *                                        * ds * hamming_window)
 *             if i > 0 and j < image.shape[1] - 1:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "skimage/transform/_radon_transform.pyx":160
 *                                          * ds * hamming_window)
 *             if i < image.shape[0] - 1 and j > 0:
 *                 image_update[i+1, j] += (deviation * di * (1 - dj)             # <<<<<<<<<<<<<<
 *                                          * ds * hamming_window)
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "skimage/transform/_radon_transform.pyx":163
 *                                          * ds * hamming_window)
 *             if i < image.shape[0] - 1 and j < image.shape[1] - 1:
 *                 image_update[i+1, j+1] += (deviation * di * dj             # <<<<<<<<<<<<<<
 *                                            * ds * hamming_window)
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(__pyx_v_deviation); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 165; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_7skimage_9transform_16_radon_transform_3bilinear_ray_update(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("bilinear_ray_update (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_image_update)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("bilinear_ray_update", 1, 5, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_theta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bilinear_ray_update", 1, 5, 5, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ray_position)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bilinear_ray_update", 1, 5, 5, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_projected_value)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("bilinear_ray_update", 1, 5, 5, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "bilinear_ray_update") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_double_t(values[0]); if (unlikely(!__pyx_v_image.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_image_update = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_double_t(values[1]); if (unlikely(!__pyx_v_image_update.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_theta = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_theta == (npy_double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_ray_position = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_ray_position == (npy_double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 90; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_projected_value = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_projected_value == (npy_double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("bilinear_ray_update", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("skimage.transform._radon_transform.bilinear_ray_update", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_7skimage_9transform_16_radon_transform_2bilinear_ray_update(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, __Pyx_memviewslice __pyx_v_image_update, __pyx_t_5numpy_double_t __pyx_v_theta, __pyx_t_5numpy_double_t __pyx_v_ray_position, __pyx_t_5numpy_double_t __pyx_v_projected_value) {
  ...
  __Pyx_RefNannySetupContext("bilinear_ray_update", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_image.memview)) { __Pyx_RaiseUnboundLocalError("image"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  if (unlikely(!__pyx_v_image_update.memview)) { __Pyx_RaiseUnboundLocalError("image_update"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;} }
  __pyx_t_1 = __pyx_f_7skimage_9transform_16_radon_transform_bilinear_ray_update(__pyx_v_image, __pyx_v_image_update, __pyx_v_theta, __pyx_v_ray_position, __pyx_v_projected_value, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "skimage/transform/_radon_transform.pyx":169
 * 
...
static PyObject *__pyx_pw_7skimage_9transform_16_radon_transform_5sart_projection_update(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("sart_projection_update (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_theta)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("sart_projection_update", 0, 3, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_projection)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("sart_projection_update", 0, 3, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "sart_projection_update") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
    ...
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_5numpy_double_t(values[0]); if (unlikely(!__pyx_v_image.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_theta = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_theta == (npy_double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 170; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_projection = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_double_t(values[2]); if (unlikely(!__pyx_v_projection.memview)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 171; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    if (values[3]) {
      __pyx_v_projection_shift = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_projection_shift == (npy_double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 172; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("sart_projection_update", 0, 3, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  if (unlikely(((PyObject *)__pyx_v_image.memview) == Py_None)) {
    PyErr_Format(PyExc_TypeError, "Argument '%.200s' must not be None", "image"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  if (unlikely(((PyObject *)__pyx_v_projection.memview) == Py_None)) {
    PyErr_Format(PyExc_TypeError, "Argument '%.200s' must not be None", "projection"); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 171; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
...
static PyObject *__pyx_pf_7skimage_9transform_16_radon_transform_4sart_projection_update(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, __pyx_t_5numpy_double_t __pyx_v_theta, __Pyx_memviewslice __pyx_v_projection, __pyx_t_5numpy_double_t __pyx_v_projection_shift) {
  ...
  /* "skimage/transform/_radon_transform.pyx":195
 *         added to ``image`` to improve the reconstruction estimate
 *     """
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_zeros_like); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 195; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_v_image, 2, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_double_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_double_t, 0);; if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 195; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  ...
  /* "skimage/transform/_radon_transform.pyx":198
 *     cdef cnp.double_t ray_position
 *     cdef Py_ssize_t i
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "skimage/transform/_radon_transform.pyx":199
 *     cdef Py_ssize_t i
 *     for i in range(projection.shape[0]):
 *         ray_position = i + projection_shift             # <<<<<<<<<<<<<<
 *         bilinear_ray_update(image, image_update, theta, ray_position,
 ...
 */
    ...
    /* "skimage/transform/_radon_transform.pyx":200
 *     for i in range(projection.shape[0]):
 *         ray_position = i + projection_shift
 *         bilinear_ray_update(image, image_update, theta, ray_position,             # <<<<<<<<<<<<<<
 *                             projection[i])
 ...
 *     return image_update
 */
    __pyx_t_1 = __pyx_f_7skimage_9transform_16_radon_transform_bilinear_ray_update(__pyx_v_image, __pyx_t_9, __pyx_v_theta, __pyx_v_ray_position, (*((__pyx_t_5numpy_double_t *) ( /* dim=0 */ (__pyx_v_projection.data + __pyx_t_10 * __pyx_v_projection.strides[0]) ))), 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 200; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __PYX_XDEC_MEMVIEW(&__pyx_t_9, 1);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  }

  /* "skimage/transform/_radon_transform.pyx":202
 *         bilinear_ray_update(image, image_update, theta, ray_position,
 *                             projection[i])
 *     return image_update             # <<<<<<<<<<<<<<
 */
 ...
 *                            cnp.double_t[:] projection not None,
 */
  __pyx_tuple__19 = PyTuple_Pack(7, __pyx_n_s_image, __pyx_n_s_theta, __pyx_n_s_projection, __pyx_n_s_projection_shift, __pyx_n_s_image_update, __pyx_n_s_ray_position, __pyx_n_s_i); if (unlikely(!__pyx_tuple__19)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(4, 0, 7, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_stefan_src_scikit_image_sk, __pyx_n_s_sart_projection_update, 169, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *                            cnp.double_t[:] projection not None,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7skimage_9transform_16_radon_transform_5sart_projection_update, NULL, __pyx_n_s_skimage_transform__radon_transfo); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_sart_projection_update, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
